/* .JS 1.04 April 2019 by schools.com */
"use strict";
var  = {};
.hide = function (sel) {
...
.displayObject = function (id, data) {
  ...
  for (j = (l - 1); j >= 0; j -= 1) {
    ...
    if (repeatObj && typeof repeatObj == "object" && repeatObj.length != "undefined") {
      ...
      for (x in repeatObj) {
        i += 1;
        rowClone = arr[j];
        rowClone = _replace_curly(rowClone, "element", repeatX, repeatObj[x]);
        a = rowClone.attributes;
        for (ii = 0; ii < a.length; ii += 1) {
          a[ii].value = _replace_curly(a[ii], "attribute", repeatX, repeatObj[x]).value;
        }
  ...
  html = _replace_curly(html, "element");
  ...
  function _replace_curly(elmnt, typ, repeatX, x) {
    ...
    while (pos1 > -1) {
      ...
      if (value != undefined) {
        ...
        if (typ == "attribute") {
          ...
          _replace_html(rowClone, r, value);
        }
      }
      pos1 = pos1 + 1;
    }
  ...
  function _replace_html(a, r, result) {
    var b, l, i, a, x, j;
    if (a.hasAttributes()) {
      b = a.attributes;
      l = b.length;
